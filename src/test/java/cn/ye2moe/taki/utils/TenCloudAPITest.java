...
public class TenCloudAPITest {
    ...
    public void recordListTest() {
        ...
        //String text = Https.get("https://www.baidu.com");

        //Result<List<Record>> result = new TenCloudAPI("cns", "RecordList", params).getResult();
        //new TenCloudAPI("cns", "RecordList", params);
